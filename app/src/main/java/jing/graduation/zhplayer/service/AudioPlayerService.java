package jing.graduation.zhplayer.service;
...
//        LogUtils.e(TAG, "AudioPlayerService.onBind: ");
    ...
    public class AudioServiceBinder extends Binder {
        ...
        private void play(){
            ...
            LogUtils.e("AudioPlayerService.onStartCommand: item=" + audioItem);
        ...
        public void seekTo(int mSec){
            LogUtils.e("AudioServiceBinder.seekTo: ");
    ...
    private Notification getNormalNotification() {
        Notification notification =
                new Notification(R.drawable.icon,
                        "正在播放： " + audioItems.get(position).getTitle(),
                        System.currentTimeMillis());

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
            notification = new Notification.Builder(getApplicationContext())
                    .setContentTitle("正在播放： " + audioItems.get(position).getTitle())
                    .setContentText(audioItems.get(position).getArties())
