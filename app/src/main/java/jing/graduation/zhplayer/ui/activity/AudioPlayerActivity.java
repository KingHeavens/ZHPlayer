...
import jing.graduation.zhplayer.lyrics.LyricLoader;
import jing.graduation.zhplayer.lyrics.LyricsView;
import jing.graduation.zhplayer.service.AudioPlayerService;
...
public class AudioPlayerActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        lyricsView = (LyricsView) findViewById(R.id.audio_player_lyricview);
...
//            File lyricFile = new File(Environment.getExternalStorageDirectory(),"Download/test/audio/"+audioItem.getTitle()+".lrc");
    ...
    private void startUpdatePosition() {
        ...
        LogUtils.e("AudioPlayerActivity.startUpdatePosition: ");
        // 获取时间参数
